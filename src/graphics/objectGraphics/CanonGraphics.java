...
public class CanonGraphics {
     ...
     * @param x X súradnica kanónu v mriežke (nie v pixeloch).
     * @param y Y súradnica kanónu v mriežke (nie v pixeloch).
     * @param angle Uhol rotácie kanónu v stupňoch.
     */
    public void getCanonGraphics(Graphics g, int x, int y, double angle) {
        Graphics2D g2d = (Graphics2D)g.create();
        int startX = x * 20; // Prepočet na základy mriežky (pixelová pozícia)
        int startY = y * 20;
